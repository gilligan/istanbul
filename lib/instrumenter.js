...
(function (isNode) {
    ...
    var SYNTAX,
        ...
        transformSourceCode = require('./util/transformSourceCode');
    ...
    Instrumenter.prototype = {
        ...
        instrumentSync: function (code, filename) {
            ...
            if (filename && filename.length > 0) {
                ...
                if (fileExtension && (fileExtension.toLowerCase() === 'jsx' || fileExtension.toLowerCase() === 'js')) {
                    code = transformSourceCode(filename);
                }
            }
